...
namespace Agora_RTC_Plugin.API_Example.Examples.Basic
{
    public class VideoCallWithToken : MonoBehaviour
    {
        ...
        private void JoinChannel()
        {
            ...
            RtcEngine.SetClientRole(CLIENT_ROLE);
    ...
    {
        private readonly VideoCallWithToken _videoSample;

        internal UserEventHandler(VideoCallWithToken videoSample)
        {
        ...
        public override void OnJoinChannelSuccess(RtcConnection connection, int elapsed)
        {
            ...
            VideoCallWithToken.MakeVideoView(0);
        }
